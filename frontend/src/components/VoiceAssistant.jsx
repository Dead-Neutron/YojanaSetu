        ...
        <div className="flex flex-col items-center justify-center my-6">
          {state === "idle" && (
            <button
              ...
              className="group w-32 h-32 sm:w-36 sm:h-36 rounded-full bg-[#F59E0B] hover:bg-[#D97706] text-[#171717] flex flex-col items-center justify-center border-4 border-[#FCD34D] civic-shadow-lg transition-all active:scale-95 animate-civic-mic"
              aria-label={t("hero.tapToSpeak")}
            >
              <Mic className="w-12 h-12 mb-1 stroke-[2.2]" />
              <span className="text-xs font-black uppercase tracking-wider inline-block transition-transform duration-200 group-hover:scale-105">
                {t("hero.tapToSpeak")}
              </span>
            </button>
          )}
          ...
          {state === "listening" && (
            <div className="flex flex-col items-center">
              <button
                ...
                className="group w-32 h-32 sm:w-36 sm:h-36 rounded-full bg-red-600 hover:bg-red-500 text-white flex flex-col items-center justify-center border-4 border-red-300 civic-shadow-lg transition-all active:scale-95"
                aria-label={t("hero.stopListening")}
              >
                <Square className="w-10 h-10 mb-1 fill-current" />
                <span className="text-xs font-bold uppercase tracking-wider inline-block transition-transform duration-200 group-hover:scale-105">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center gap-3 mt-5">
                <button
                  ...
                  className="group bg-[#122844] hover:bg-[#23487A] text-white px-4 py-2 rounded-xl text-xs font-semibold border border-[#23487A] flex items-center gap-1.5 transition-all"
                >
                ...
                <button
                  ...
                  className="group bg-[#F59E0B] hover:bg-[#D97706] text-[#171717] px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all"
                >
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {sampleQueries.map((item, idx) => (
              <button
                ...
                className="group bg-[#122844] hover:bg-[#23487A] text-slate-100 hover:text-white px-4 py-2 rounded-xl text-xs font-semibold border border-[#23487A] flex items-center gap-2 transition-all active:scale-95 civic-shadow-sm"
              >
      ...
      {matchedSchemes.length > 0 && (
        <div className="mt-10 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <a
              href="/search"
              className="group hidden sm:inline-flex items-center gap-1.5 text-sm font-bold text-[#1A365D] hover:text-[#00A3C4] transition-colors"
            >
              <span className="inline-block transition-transform duration-200 group-hover:scale-105">
                {t("hero.exploreAll")}
              </span>
